<template>
  <div class="baseInfo">
    <div class="baseInfo_item">
      <div class="bt_title">调查标题</div>
      <div class="bt_input">
        <el-input size="medium" v-model="review.title"></el-input>
        <span class="errorTip" data-name="title">
          <i class="el-icon-circle-close"></i> 请输入调查标题，在提交</span
        >
      </div>
    </div>
    <div class="baseInfo_item">
      <div class="bt_title">调查分类</div>
      <div class="bt_input">
        <el-select
          v-model="review.surveyClass"
          style="width: 500px"
          size="medium"
          placeholder="请选择类别"
        >
        ...
        <span class="errorTip" data-name="title">
          <i class="el-icon-circle-close"></i> 请选择调查分类，在提交</span
        >
      </div>
    </div>
    <div class="baseInfo_item">
      <div class="bt_title">调查时间</div>
      <div class="bt_input">
        <el-date-picker
          style="width: 500px"
          v-model="review.date"
        ...
        <span class="errorTip" data-name="date">
          <i class="el-icon-circle-close"></i> 请选择调查时间，在提交</span
        >
      </div>
    </div>
    <div class="baseInfo_item">
      <div class="bt_title">调查说明</div>
      <div class="bt_input">
        <el-input
          size="medium"
          type="textarea"
        ...
        <span class="errorTip" data-name="mark">
          <i class="el-icon-circle-close"></i> 请输入调查说明，在提交</span
        >
      </div>
    </div>
    <div class="baseInfo_item">
      <div class="bt_title">是否同IP参与调查</div>
      <div class="bt_input">
    ...
    <div class="baseInfo_item">
      ...
      <div class="bt_input">
        ...
        <span class="errorTip" data-name="accessIp">
          <i class="el-icon-circle-close"></i> 请输入允许IP段，在提交</span
        >
      </div>
    </div>
    <div class="baseInfo_item">
    ...
    <div class="baseInfo_item">
      <div class="bt_title">参评调查人员</div>
      <div class="bt_input">
        <el-select
          v-model="review.people"
          style="width: 500px"
          size="medium"
          placeholder="请选择参评人员"
        >
        ...
        <span class="errorTip" data-name="accessIp">
          <i class="el-icon-circle-close"></i> 请选择参评调查人员，在提交</span
        >
      </div>
    </div>
