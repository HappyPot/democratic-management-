        ...
        <div class="baseInfo">
          ...
          <div class="base_table">
            ...
            >
              ...
              <el-table-column prop="name" label="人员编码"> </el-table-column>
              <el-table-column prop="date" label="单位名称"> </el-table-column>
              <el-table-column prop="date" label="部门名称"> </el-table-column>
              <el-table-column prop="date" label="人员类别"> </el-table-column>
              <el-table-column prop="date" label="满意"> </el-table-column>
              <el-table-column prop="date" label="满意"> </el-table-column>
              <el-table-column prop="date" label="满意"> </el-table-column>
              <el-table-column prop="date" label="满意"> </el-table-column>
