  ...
  <d2-container class="page"
      ...
      <div class="em_input_right">
        ...
        <div class="em_input">
          <el-button type="danger"
                     ...
                     plain
                     @click="delItemList"
                     :disabled="selection.length == 0 || selection.length > 1">删除</el-button>
        </div>
      </div>
    </div>
    <!-- 表格 -->
        ...
        <el-table-column label="操作"
          ...
          <template slot-scope="scope">
            <el-link type="primary"
                     ...
                     @click="showTestRate(scope.row, scope.$index)">查看参评率</el-link>
            <el-link type="primary"
                     style="margin-right: 12px"
    ...
    <el-dialog title="事项配置"
      ...
      <Configure ref="configure"
                 v-if="dialogConfigure"></Configure>
      <span slot="footer"
            class="dialog-footer">
        <el-button type="primary"
    ...
    <el-dialog title="明细查询"
               ...
               :close-on-click-modal="false"
               width="1000px">
      <DetailQuery v-if="dialogDetailRadio"
                   :idInfo="idInfo"></DetailQuery>
      <DetailQueryText v-if="dialogDetailText"
                       :idInfo="idInfo"></DetailQueryText>
      <span slot="footer"
            class="dialog-footer">
        <el-button type="primary"
                   @click="closeDetail">确 定</el-button>
    ...
    <el-dialog :title="testTitle"
      ...
      <span slot="footer"
            class="dialog-footer">
        <el-button type="primary"
                   @click="dialogTest = false">确 定</el-button>
        <el-button @click="dialogTest = false">取 消</el-button>
      </span>
    </el-dialog>
    <!--查看参评率 -->
    <el-dialog title="查看参评率"
               center
      ...
      <div class="testRate">
        <div class="exportList"
             @click="exportExcel">
          <img src="../../../assets/image/exportlist.svg"
               alt="" /> 批量导出
        </div>
        <el-table :data="tableDataTestRate"
          ...
          <el-table-column prop="user_total"
                           label="总人数">
          </el-table-column>
          <el-table-column prop="cyrs"
                           label="参与人数"> </el-table-column>
          ...
          <el-table-column prop="no_cyrs"
                           label="未参与测评人数">
            <template slot-scope="scope">
              <el-link type="primary"
                       @click="showNoTest(scope.row)">{{ scope.row.no_cyrs }}</el-link>
            </template>
      ...
      <span slot="footer"
            class="dialog-footer">
        <el-button type="primary"
                   @click="dialogTestRate = false">确 定</el-button>
        <el-button @click="dialogTestRate = false">取 消</el-button>
      </span>
    </el-dialog>
    <!--未参与人数 -->
    <el-dialog title="未参与人数"
               center
      ...
      <div class="testRate ">
        <div class="exportList"
             @click="getQuestionNotInExprot">
          <img src="../../../assets/image/exportlist.svg"
               alt="" /> 批量导出
        </div>
        <div class="testRateNo">
          <el-table :data="tableDataTestRateNo"
                    height="600"
      ...
      <span slot="footer"
            class="dialog-footer">
        <el-button type="primary"
                   @click="dialogTestRateNo = false">确 定</el-button>
        <el-button @click="dialogTestRateNo = false">取 消</el-button>
      </span>
    </el-dialog>
    <!-- 社会评议人员 -->
    <el-dialog title="社会公众评议"
               center
        ...
        <div class="em_input"
          ...
          <div class="ul_item">
            <el-input class="inline-input"
              ...
              <template slot="append">
                <div class="search_append"
                     @click="searchPublicList">搜索</div>
              </template>
            </el-input>
          </div>
        </div>
        <div class="exportList"
             @click="getPublicExprot">
          <img src="../../../assets/image/exportlist.svg"
               alt="" /> 批量导出
        </div>
        <div class="testRateNo">
          <el-table :data="tableDataPublic"
                    height="600"
