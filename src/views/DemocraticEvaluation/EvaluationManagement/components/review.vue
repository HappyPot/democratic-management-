<template>
  <div class="review">
    <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
      ...
      <el-tab-pane label="参评人员" name="third">
      ...
      <el-tab-pane label="评议主体" name="fourth">
        <div class="appraisal_subject">
          ...
          >
            ...
            <div class="bt_input">
              <el-input
                size="medium"
                v-model="appraisalSubject[index]"
              ></el-input>
              <span class="errorTip errorsubject" data-name="appraisalSubject">
                <i class="el-icon-circle-close"></i> 请输入评议主体{{
                  index + 1
                }}，在提交</span
              >
              <div class="del_btn" @click="delSubject">
  ...
  data() {
    return {
      ...
      peopleTableData: [
        ...
        { id: 2, date: "2016-05-04", name: "王小虎", address: "上海市" },
        { id: 3, date: "2016-05-01", name: "王小虎", address: "上海市" },
        {
          id: 4,
          date: "2016-05-03",
          name: "王小虎",
