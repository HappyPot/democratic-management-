<template>
  <d2-container class="page">
        ...
        <el-table-column label="操作" show-overflow-tooltip>
          <template>
            <el-link type="primary" style="margin-right: 12px" @click="showEdit"
              >编辑</el-link
            >
            <el-link type="danger" @click="delItem">删除</el-link>
          </template>
        </el-table-column>
      </el-table>
    ...
    <!--新增 -->
    <el-dialog title="新增职务" center :visible.sync="dialogAdd" width="700px">
      <div class="addNew">
        <div class="dc_item">
          ...
          <el-input
            ...
            placeholder="请输入职务编号"
          ></el-input>
          <span class="errorTip" data-name="jobNo">
        ...
        <div class="dc_item">
          ...
          <el-input
            v-model="from.jobName"
            class="dc_select"
            size="medium"
            placeholder="请输入职务名称"
          ></el-input>
          <span class="errorTip" data-name="jobName">
