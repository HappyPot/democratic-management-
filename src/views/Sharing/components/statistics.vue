            ...
            <div class="result">
              ...
              <div class="result_chart">
                ...
                <div class="rc_switch">
                  ...
                  >
                    <img v-if="btnType == 1" src="../image/pie.png" alt="" />
                    <img v-else src="../image/pie_gray.png" alt="" />
                    饼状图
                  </div>
                  <div
                    :class="
                  ...
                  >
                    <img v-if="btnType == 2" src="../image/bar.png" alt="" />
                    <img v-else src="../image/bar_gray.png" alt="" />
                    柱状图
                  </div>
                  <div
                    :class="
                  ...
                  >
                    <img v-if="btnType == 3" src="../image/line.png" alt="" />
                    <img v-else src="../image/line_gray.png" alt="" />
                    条形图
                  </div>
                  <div
                    :class="
                  ...
                  >
                    <img
                      ...
                      alt=""
                    />
                    <img v-else src="../image/brokenline_gray.png" alt="" />
                    折线图
                  </div>
                </div>
                <!-- 图表部分 -->
                <div class="rc_chart">
                  <div :id="'my_chart_' + i" class="my_chart"></div>
                </div>
              </div>
            </div>
          </div>
